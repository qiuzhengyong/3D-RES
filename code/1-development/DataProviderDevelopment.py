...
class AudioDataset():
    ...
    def __init__(self, files_path, audio_dir, transform=None):
        ...
        for x in content:
            ...
            if id==last and num==NUM_EVERY :
                continue
            elif id==last and num<NUM_EVERY:
                num+=1
                last=id
            elif id!=last and num==NUM_EVERY:
                num=1
    ...
    def __getitem__(self, idx):
        ...
        logenergy = speechpy.feature.lmfe(signal, sampling_frequency=fs, frame_length=0.025, frame_stride=0.01,
                                          num_filters=num_coefficient, fft_length=1024, low_frequency=0, high_frequency=None)
...
class CMVN(object):
    ...
    def __call__(self, sample):
        ...
        # feature = speechpy.processing.cmvn(feature, variance_normalization=False)
